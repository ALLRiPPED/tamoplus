...
infobox="${infobox}\n"
infobox="${infobox}This script will update Skyscraper engine to the latest release. You can use it to install on a clean new systems or re-install in case something got corrupt.\n"
...
--title "Skyscraper Retropie Script" \
