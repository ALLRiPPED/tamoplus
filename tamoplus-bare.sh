...
stats_check
    local choice
    while true; do
        choice=$(dialog --colors --backtitle "Visual Menu" --title " Visual Menu " \
            --ok-label OK --cancel-label Exit \
            --menu "Choose An Option Below" 25 85 20 \
...
stats_check
    local choice
    while true; do
        choice=$(dialog --colors --backtitle "Loading Media Menu" --title " Loading Media Menu " \
            --ok-label OK --cancel-label Exit \
            --menu "Choose An Option Below" 25 85 20 \
...
stats_check
    local choice
    while true; do
        choice=$(dialog --colors --backtitle "Loading Video Menu" --title " Loading video Menu " \
            --ok-label OK --cancel-label Exit \
            --menu "Choose An Option Below" 25 85 20 \
...
stats_check
    local choice
    while true; do
        choice=$(dialog --colors --backtitle "Theme Settings" --title " Theme Settings " \
            --ok-label OK --cancel-label Exit \
            --menu "Choose An Option Below" 25 85 20 \
            1 "Hursty Themes" \
            2 "RetroPie Themes" \
...
stats_check
    local choice
    while true; do
        choice=$(dialog --colors --backtitle "Music Settings" --title " Music Settings " \
            --ok-label OK --cancel-label Exit \
            --menu "Choose An Option Below" 25 85 20 \
...
stats_check
    local choice
    while true; do
        choice=$(dialog --colors --backtitle "Quick Audio Fixes" --title " Music Settings " \
            --ok-label OK --cancel-label Exit \
            --menu "Choose An Option Below" 25 85 20 \
...
local choice
    while true; do
        choice=$(dialog --colors --backtitle "TAMO+ OverLay Settings" --title " Overlay Menu " \
